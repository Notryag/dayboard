...
docker compose -f docker-compose.yml -f docker-compose.platform.yml build api worker web
...
```bash
# 仅更新 Web
docker compose -f docker-compose.yml -f docker-compose.platform.yml build web
docker compose -f docker-compose.yml -f docker-compose.platform.yml up -d --no-deps web

# 更新 API 与 Worker；两者共用 API 镜像
docker compose -f docker-compose.yml -f docker-compose.platform.yml build api worker
docker compose -f docker-compose.yml -f docker-compose.platform.yml up -d --no-deps api worker
```
...
```bash
docker compose -f docker-compose.yml -f docker-compose.platform.yml logs --tail=100 api worker web
docker compose -f docker-compose.yml -f docker-compose.platform.yml logs -f api worker
docker compose -f docker-compose.yml -f docker-compose.platform.yml events
```
